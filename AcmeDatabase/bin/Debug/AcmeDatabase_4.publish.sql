...
GO
/*
The column [dbo].[User].[Address] is being dropped, data loss could occur.

The column [dbo].[User].[AddressId] on table [dbo].[User] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
PRINT N'Dropping [dbo].[fk_user_address]...';
...
GO
PRINT N'Altering [dbo].[CreateUser]...';
...
RETURN
GO
PRINT N'Altering [dbo].[GetUserImage]...';


GO
ALTER PROCEDURE [dbo].[GetUserImage]
	@UserId int
AS
